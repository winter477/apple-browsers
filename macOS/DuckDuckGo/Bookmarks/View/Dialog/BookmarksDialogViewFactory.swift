...
enum BookmarksDialogViewFactory {
    ...
    static func makeAddBookmarkFolderView(parentFolder: BookmarkFolder?, bookmarkManager: BookmarkManager) -> AddEditBookmarkFolderDialogView {
    ...
    ///   - bookmarkManager: An instance of `BookmarkManager`. This should be used for `#previews` only.
    /// - Returns: An instance of AddEditBookmarkFolderDialogView.
    static func makeEditBookmarkFolderView(folder: BookmarkFolder, parentFolder: BookmarkFolder?, bookmarkManager: BookmarkManager) -> AddEditBookmarkFolderDialogView {
    ...
    static func makeAddBookmarkView(currentTab: WebsiteInfo?, bookmarkManager: BookmarkManager) -> AddEditBookmarkDialogView {
    ...
    ///  - bookmarkManager: An instance of `BookmarkManager`. This should be used for `#previews` only.
    /// - Returns: An instance of AddEditBookmarkDialogView.
    static func makeAddBookmarkView(parent: BookmarkFolder?, bookmarkManager: BookmarkManager) -> AddEditBookmarkDialogView {
    ...
    /// - Returns: An instance of AddEditBookmarkDialogView,
    static func makeAddFavoriteView(bookmarkManager: BookmarkManager) -> AddEditBookmarkDialogView {
    ...
    ///   - bookmarkManager: An instance of `BookmarkManager`. This should be used for `#previews` only.
    /// - Returns: An instance of AddEditBookmarkDialogView.
    static func makeEditBookmarkView(bookmark: Bookmark, bookmarkManager: BookmarkManager) -> AddEditBookmarkDialogView {
    ...
    static func makeBookmarkAllOpenTabsView(websitesInfo: [WebsiteInfo], bookmarkManager: BookmarkManager) -> BookmarkAllTabsDialogView {
