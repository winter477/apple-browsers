//
//  VisualizeFireAnimationDeciderTests.swift
//
...
final class VisualizeFireAnimationDeciderTests: XCTestCase {
    ...
    func testWhenFeatureFlagIsOnAndFireAnimationIsDisabled_thenShouldShowFireAnimationIsFalse() {
        ...
        let sut = DefaultVisualizeFireAnimationDecider(featureFlagger: featureFlagger, dataClearingPreferences: dataClearingPreferences)
