...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/duckduckgo/duckduckgo-autofill.git", exact: "17.0.1"),
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts", exact: "8.11.0"),
